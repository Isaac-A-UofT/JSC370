...
```sh
Github: https://github.com/Isaac-A-UofT/JSC370
Link foor Cloning: https://github.com/Isaac-A-UofT/JSC370.git
...
```sh
commit a72a3e9780ed9681805305f26ac75db79f237d9a (HEAD -> Isaac-Abell, origin/Isaac-Abell)
Author: Isaac-A-UofT <isaac.abell@mail.utoronto.ca>
Date:   Wed Jan 14 13:45:00 2026 -0500

    update name with info
```
